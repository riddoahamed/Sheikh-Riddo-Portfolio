...
export const mockData = {
  ...
  ventures: [
    ...
    },
    {
      id: 2,
      name: "Cashflow Cult",
      description: "A free investment education platform for Bangladeshis worldwide. Helping Gen Z, Millennials, and diaspora communities navigate their financial journeys. Story-driven lessons, AI-guided tools, and pilot programs that promote financial inclusion.",
